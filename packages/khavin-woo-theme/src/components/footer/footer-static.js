                ...
                <div className="footer__top">
                    {sidebarOne ? (
                        <div dangerouslySetInnerHTML={{ __html: sanitize(sidebarOne) }}
                            className="footer__sidebar-one footer-widget"></div>
                    ) : null}
                ...
                <div className="footer__bottom">
                    <div className="copyright-text">
                        {copyrightText ? (
                            ...
                            <a href="https://codeytek.com" target="_blank" rel="noreferrer">Khavinsolution 2022</a>
                        )}
                    </div>
...
Footer.defaultProps = {
    copyrightText: `KhavinSolution ${new Date().getFullYear()}`,
};
